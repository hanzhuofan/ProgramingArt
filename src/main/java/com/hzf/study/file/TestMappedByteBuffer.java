...
public class TestMappedByteBuffer {
    ...
    private static Tester[] testers = {new Tester("Stream RW") {
        ...
        public void test() {
            try (FileChannel channel = FileChannel.open(Paths.get("src/b.txt"), StandardOpenOption.READ,
        ...
        public void test() {
            try (FileChannel channel = FileChannel.open(Paths.get("src/c.txt"), StandardOpenOption.READ,
                StandardOpenOption.WRITE);) {
