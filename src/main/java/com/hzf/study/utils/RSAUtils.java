...
public class RSAUtils {
    ...
    private static void testSign(String publicKey, String privateKey) throws Exception {
        ...
        String sign = RSAUtils.sign(encodedData.getBytes(), privateKey);
        System.out.println("签名:\r" + sign);
        boolean status = RSAUtils.verify(encodedData.getBytes(), publicKey, sign);
    ...
    public static String decryptByPrivateKey(String encryptedData, String privateKey) throws Exception {
        return new String(decryptByPrivateKey(Base64.getDecoder().decode(encryptedData), privateKey));
    }
